    ...
    <div className="page download">
      ...
      <div className="download-cards">
        <div className="download-card">
          ...
          <h3>Windows</h3>
          <a href="https://github.com/sreegjl/timelines/releases/download/v0.5.0-alpha.1/Timelines-0.5.0-alpha.1-Setup.exe" className="btn btn-primary">Download for Windows</a>
          <span className="download-meta">.exe &middot; 64-bit</span>
        </div>
        <div className="download-card">
          <img src={`${import.meta.env.BASE_URL}icon.png`} alt="Timelines app icon" className="download-card-icon" />
          <h3>macOS</h3>
          <a href="https://github.com/sreegjl/timelines/releases/download/v0.5.0-alpha.1/Timelines-0.5.0-alpha.1-Setup.dmg" className="btn btn-primary">Download for Mac</a>
