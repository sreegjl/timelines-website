...
- Planning story structure or character arcs over time
- Tracking project timelines or personal history

## How Does It Work?

Timelines are built from three element types:

- **Events** - a single point in time
- **Spans** - a named period with a start and end; can branch off and merge with each other to show diverging and converging threads
- **Eras** - large-scale categorizations that group spans and events into broader periods

Groups layer elements into separate lanes. Tags let you filter and color-code across the whole timeline. **[[Notes]]** attach Markdown documents or MediaWiki links to any element.


---

*Timelines is open source. Feedback and contributions welcome on [GitHub](https://github.com/sreegjl/timelines).*
